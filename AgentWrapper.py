...
class AgentWrapper:
    ...
    2.3. **Generative AI (GenAI) Platform** – DigitalOcean’s AI-focused infrastructure enabling agent creation and RAG workflows/pipelines along with an assortment of multiple LLM models to utilize for agent creation/orchestration.
